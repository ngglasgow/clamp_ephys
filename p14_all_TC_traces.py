...
''' make two separate groups of TCs depending on size of response (manually determined) '''
p14_light_TCs_small = p14_light_TCs.drop(columns=['JH191008_c3_light100', 'JH191009_c3_light100'])

p14_light_TCs_large = p14_light_TCs.loc[:,['JH191008_c3_light100', 'JH191009_c3_light100']]
...
n_cells = len(p14_light_TCs_small.columns)

# rename columns for indexing
p14_light_TCs_small.columns = range(n_cells)
...
filename = 'p14_TC_small_simplifed_traces_noaxes.png'
...
filename = 'p14_TC_small_simplifed_traces_axes.png'
path = r"C:\Users\jhuang\Documents\phd_projects\Injected_GC_data\VC_pairs\figures\p14"
savepath = os.path.join(path, filename)
fig.savefig(savepath, dpi=300, format='png')
plt.close()
...
''' some parameters for automating figure sizing and rows '''
n_cells = len(p14_light_TCs_large.columns)

# rename columns for indexing
p14_light_TCs_large.columns = range(n_cells)
...
filename = 'p14_TC_large_simplifed_traces_noaxes.png'
path = r"C:\Users\jhuang\Documents\phd_projects\Injected_GC_data\VC_pairs\figures\p14"
savepath = os.path.join(path, filename)
fig.savefig(savepath, dpi=300, format='png')
plt.close()
...
filename = 'p14_TC_large_simplifed_traces_axes.png'
path = r"C:\Users\jhuang\Documents\phd_projects\Injected_GC_data\VC_pairs\figures\p14"
savepath = os.path.join(path, filename)
fig.savefig(savepath, dpi=300, format='png')
plt.close()