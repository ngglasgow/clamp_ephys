...
figure_dir = r'C:\Users\Jane Huang\Documents\Grad school\Urban Lab\Data Analysis\Injected_GC_data\New_VC_pairs\JH190829\slice_2\MC\figures'
...
plotx_end = 15000           # index of time axis you want to stop plotting
...
# fig
# save figure to file
fig_save_path = os.path.join(figure_dir, 'JH190829_slice2_MCs')
fig.savefig(fig_save_path + '_waves_final.png', dpi=300, format='png')

''' ############### same figure as above but with scales ################## '''
# generate the figure with all the subplots
fig_scales, axs = plt.subplots(n_cells, 1, figsize=(width, height), constrained_layout=True)
