...
for file_name in file_name_list:
    ...
    mean_timeseries_path = os.path.join(table_dir, genotype + '_' + cell_id)
    filt_data_mean.to_csv(mean_timeseries_path + '_mean_timeseries.csv', float_format='%8.4f', index=False, header=False)
