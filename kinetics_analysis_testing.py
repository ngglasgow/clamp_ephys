...
test_notes = os.path.join(test_data_path, 'p2_data_notes.csv')
...
for file_number, cell in enumerate(test_data_files):
    data = clamp_ephys.workflows.cell(cell, fs=fs, path_to_data_notes=test_notes, timepoint=timepoint, amp_factor=amp_factor)
