...
p2_light_TCs_small = p2_light_TCs.drop(columns=['JH200303_c2_light100', 'JH200303_c6_light100', 'JH200303_c8_light100',
                                                'JH200304_c2_light100', 'JH200310_c4_light100', 'JH200311_c2_light100'])

p2_light_TCs_large = p2_light_TCs.loc[:,['JH200303_c2_light100', 'JH200303_c6_light100', 'JH200303_c8_light100',
                                        'JH200304_c2_light100', 'JH200310_c4_light100', 'JH200311_c2_light100']]
...
''' making plots for TCs with small responses '''

''' some parameters for automating figure sizing and rows '''
n_cells = len(p2_light_TCs_small.columns)

# rename columns for indexing
p2_light_TCs_small.columns = range(n_cells)
...
filename = 'p2_TC_small_simplifed_traces_noaxes.png'
...
filename = 'p2_TC_small_simplifed_traces_axes.png'
path = r"C:\Users\jhuang\Documents\phd_projects\Injected_GC_data\VC_pairs\figures\p2"
savepath = os.path.join(path, filename)
fig.savefig(savepath, dpi=300, format='png')
plt.close()

''' making plots for TCs with large responses '''

''' some parameters for automating figure sizing and rows '''
n_cells = len(p2_light_TCs_large.columns)

# rename columns for indexing
p2_light_TCs_large.columns = range(n_cells)
...
filename = 'p2_TC_large_simplifed_traces_noaxes.png'
path = r"C:\Users\jhuang\Documents\phd_projects\Injected_GC_data\VC_pairs\figures\p2"
savepath = os.path.join(path, filename)
fig.savefig(savepath, dpi=300, format='png')
plt.close()
...
filename = 'p2_TC_large_simplifed_traces_axes.png'
path = r"C:\Users\jhuang\Documents\phd_projects\Injected_GC_data\VC_pairs\figures\p2"
savepath = os.path.join(path, filename)
fig.savefig(savepath, dpi=300, format='png')
plt.close()