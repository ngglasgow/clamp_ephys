...
p2_light_MCs_small = p2_light_MCs.drop(columns=['JH200311_c4_light100', 'JH200311_c6_light100', 'JH200313_c3_light100'])

p2_light_MCs_large = p2_light_MCs.loc[:,['JH200311_c4_light100', 'JH200311_c6_light100', 'JH200313_c3_light100']]
...
n_cells = len(p2_light_MCs_small.columns)

# rename columns for indexing
p2_light_MCs_small.columns = range(n_cells)
...
filename = 'p2_MC_small_simplifed_traces_noaxes.png'
...
filename = 'p2_MC_small_simplifed_traces_axes.png'
path = r"C:\Users\jhuang\Documents\phd_projects\Injected_GC_data\VC_pairs\figures\p2"
savepath = os.path.join(path, filename)
fig.savefig(savepath, dpi=300, format='png')
plt.close()
...
''' some parameters for automating figure sizing and rows '''
n_cells = len(p2_light_MCs_large.columns)

# rename columns for indexing
p2_light_MCs_large.columns = range(n_cells)
...
filename = 'p2_MC_large_simplifed_traces_noaxes.png'
path = r"C:\Users\jhuang\Documents\phd_projects\Injected_GC_data\VC_pairs\figures\p2"
savepath = os.path.join(path, filename)
fig.savefig(savepath, dpi=300, format='png')
plt.close()
...
filename = 'p2_MC_large_simplifed_traces_axes.png'
path = r"C:\Users\jhuang\Documents\phd_projects\Injected_GC_data\VC_pairs\figures\p2"
savepath = os.path.join(path, filename)
fig.savefig(savepath, dpi=300, format='png')
plt.close()